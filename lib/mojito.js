Mojito = (function () {
    ...
    var Test = (function () {
        var constructor = function (options) {
            ...
            // Set any defaults
            for (p in Defaults) {
                if (!this.options.options[p]) this.options.options[p] = Defaults[p];
            }
        ...
        constructor.prototype = {
            ...
            trackRecipeFailureEvent: function (error) {
                this.options.storageAdapter.onRecipeFailure(this, error.stack?error.stack.substr(0, Defaults.maxErrorStackLength):(error.message||error));
            },
            /**
            ...
            setCookie: function (name, value) {
                ...
                Cookies.set(cookieName, value, { expires: this.options.options.cookieDuration||Defaults.cookieDuration }, this.options.options.cookieDomain);
            },
    ...
    var Utils = {
        ...
        _waitUntilChecker: function () {
            ...
            if (this.waitListeners.length) {
                this.waitHandle = window.setTimeout(this._waitUntilChecker.bind(this), Defaults.waitInterval);
            } else {
        ...
        waitUntil: function (conditionFunction, callback, timeout) {
            ...
            if (timeout != null) {
                ...
                timeout = Defaults.defaultWaitTimeout;
            }
    ...
    Defaults.excluded = !navigator.cookieEnabled;
