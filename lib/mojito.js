Mojito = (function () {
    ...
    var Test = (function () {
        ...
        constructor.prototype = {
            ...
            setCookie: function (name, value) {
                ...
                Cookies.set(cookieName, value, { expires: this.options.options.cookieDuration||defaultOptions.cookieDuration }, this.options.options.cookieDomain||defaultOptions.cookieDomain);
            },
    ...
    var Utils = {
        ...
        getMojitoUserId: function () {
            ...
            if (userId) {
                Cookies.set(cookieName, userId, { expires: expires }, defaultOptions.cookieDomain);
                return userId;
            }
