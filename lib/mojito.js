Mojito = (function ()
{
    ...
    var Test = (function ()
    {
        ...
        var constructor = function (options)
        {
            ...
            // decision adapter if TEST adapter defined, use it;
            // else if GLOBAL adapter defined, use that;
            // else use DEFAULT adapter 
        ...
        constructor.prototype = {
            ...
            {
                var recipes = this.options.recipes;
                var chosenRecipe, partitions, chosenPartition, sameRecipes;
                ...
                else
                {
                    var orderedRecipes = this.getOrderedBySampleRecipes(),
                        sameSimpleRateRecipes = this.getSameSimpleRateValueRecipes(orderedRecipes),
                    ...
                    for (var i = 0; i < orderedRecipes.length; i++)
                    {
                        ...
                        if (weight <= checkedRecipeSamples)
                        {
                            ...
                            if (sameRecipes)
                            {
                                ...
                                chosenPartition = Math.floor(this.getRandom() / partitions);
                                chosenRecipe = sameRecipes[chosenPartition].key;
                            }
